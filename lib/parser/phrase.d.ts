...
export declare namespace Phrase {
    function create(type: PhraseType, children: (Phrase | Token)[]): Phrase;
    function createParseError(children: (Phrase | Token)[], unexpected: Token, expected?: TokenType): ParseError;
}
