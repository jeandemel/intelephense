...
var PackedPosition;
(function (PackedPosition) {
    function pack(line, character) {
        return ((line & 0xfffff) << 11) | (character & 0x7ff);
    }
    PackedPosition.pack = pack;
    function line(packedPosition) {
        return packedPosition >>> 11;
    }
    PackedPosition.line = line;
    function character(packedPosition) {
        return packedPosition & 0x7ff;
    }
    PackedPosition.character = character;
})(PackedPosition = exports.PackedPosition || (exports.PackedPosition = {}));
